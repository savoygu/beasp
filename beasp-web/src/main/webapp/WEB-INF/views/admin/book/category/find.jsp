		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-10 main-content">
					...
					<h3 class="page-header">书籍类别查询</h3>
					<div class="jumbotron">
						<form action="<%=bookAdminPath %>/categories" method="POST" class="form-horizontal" id="form">
							<input type="hidden" name="query" value="true">
							<div class="form-group">
								<label for="name" class="col-sm-2 control-label">类别名称</label>
								<div class="col-sm-5">
									<input type="text" name="name" class="form-control" id="name" placeholder="类别名称" required="required"/>
								</div>
