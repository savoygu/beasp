...
<title>我的浏览-${user.nickName }的个人空间-书籍交换与分享平台</title>
	...
	<section id="main">
		<div class="main-body w-1200 container cf">
			...
			<div class="r space-main">
				<div class="family cf">
					<h1 class="l family-hd">我的浏览</h1>
				</div>
				<!-- 工具条开始 -->
				<div class="book-tool-bar cf">
					<div class="tool-left l">
						<a class="sort-item active" href="<%=beaspPath %>/space/u/uid/${id}">我的浏览</a>
					</div>
									...
									<a target="_blank" href="<%=beaspPath%>/book/view/${bu.book.id}">
										<div class="book-list-img">
											...
											<c:if test="${fn:length(collections) != 0 }">
												<i class="btn-add-collection <c:if test='${fn:contains(collectionstrs, bu.book.id) }'>btn-remove-collection </c:if>"></i>
											</c:if>
											<c:if test="${fn:length(collections) == 0 }">
