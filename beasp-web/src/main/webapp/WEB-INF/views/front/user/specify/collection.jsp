...
<title>TA的收藏-${spuser.nickName }的个人空间-书籍交换与分享平台</title>
	...
	<section id="main">
		<div class="main-body w-1200 container cf">
			...
			<div class="r space-main">
				<div class="family cf">
					<h1 class="l family-hd">TA的收藏</h1>
				</div>
				<!-- 工具条开始 -->
				<div class="book-tool-bar cf">
					<div class="tool-left l">
						<a class="sort-item active" href="<%=beaspPath %>/space/collection/u/uid/${id}">TA的收藏</a>
					</div>
