		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-10 main-content">
					...
					<h3 class="page-header">书籍修改</h3>
					<div class="jumbotron">
						<form:form action="${pageContext.request.contextPath }/admin/book/book/${book.id }" method="POST" modelAttribute="book" 
							class="form-horizontal" id="form">	
							<c:if test="${!empty pageNo }"><!-- 返回当前页 -->
